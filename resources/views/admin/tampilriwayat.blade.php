                                                ...
                                                <div class="col-lg-12">
                                                    {{-- <div class="col-lg-6">
                                                        {{-- <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="NIK" type="text" value="{{$data->NIK}}" id="example-text-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Nama</label>
                                                            <input class="form-control" name="Nama" type="text" value="{{$data->Nama}}" id="example-search-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Tempat Lahir</label>
                                                            <input class="form-control" name="TempatLahir" type="text" value="{{$data->TempatLahir}}" id="example-search-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-email-input" class="form-label">Tanggal Lahir</label>
                                                            <input class="form-control" name="TanggalLahir" type="date" value="{{$data->TanggalLahir}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="Tanggal" type="date" value="{{$data->Tanggal}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-email-input" class="form-label">Berat Badan</label>
                                                            <input class="form-control" name="BB" type="text" value="{{$data->BB}}" id="example-email-input">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="TB" type="text" value="{{$data->TB}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            ...
                                                            {{-- <input class="form-control" name="TTD" type="text" value="{{$data->TTD}}" id="example-email-input"> --}}
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-email-input" class="form-label">Lingkar Lengan Atas</label>
                                                            <input class="form-control" name="LILA" type="text" value="{{$data->LILA}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-email-input" class="form-label">Lingkar Perut</label>
                                                            <input class="form-control" name="LP" type="text" value="{{$data->LP}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">

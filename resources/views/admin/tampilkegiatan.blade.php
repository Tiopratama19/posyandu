                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Kegiatan</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Silahkan Edit Kegiatan</h4>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="Jabatan" type="text" value="{{$data->Jabatan}}" id="example-search-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Uraian Kegiatan</label>
                                                            <input class="form-control" name="UraianKegiatan" type="text" value="{{$data->UraianKegiatan}}" id="example-search-input">
                                                        </div>
                                                        <span style="float:right">

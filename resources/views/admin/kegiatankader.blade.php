            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tabel Kegiatan Anggota</h4>
                        <p class="card-title-desc">Pastikan kegiatan yang dimasukkan itu sudah tepat dan benar.</p>
                        <span style="float:right">
                            <a href="/admin/tambahkegiatan" class="btn btn-primary">Tambah Anggota <i class="fa fa-plus"></i></a>
                        </span>
                    </div>
                    ...
                    @endif
                    <div class="card-body">
                        <table id="datatable" class="table table-striped nowrap dt-responsive nowrap w-100 display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="50px">No</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ url('kader', $row->image) }}" style="height: 100px; width:100px;"></td>

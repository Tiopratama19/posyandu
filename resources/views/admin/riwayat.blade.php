                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span style="float:right">
                                    <a href="/admin/insertriwayat" class="btn btn-primary">Tambah
                                        Data</a>
                                </span>
                            </div>
...
@push('scripts')
    ...
    <script
        src="{{ asset('template1/theme/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
    </script>

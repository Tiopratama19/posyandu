                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Proker</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Silahkan Edit Proker</h4>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row">
                                            <form action="/admin/updateproker/{{ $data->id }}" method="POST">
                                            @csrf
                                                <div class="col-lg-12">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Kegiatan</label>
                                                            <input class="form-control" name="Kegiatan" type="text" value="{{$data->Kegiatan}}" id="example-search-input">
                                                        </div>
                                                        <span style="float:right">

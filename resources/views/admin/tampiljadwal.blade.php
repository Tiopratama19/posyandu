                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="TanggalKegiatan" type="date" value="{{$data->TanggalKegiatan}}" id="example-email-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Nama Kegiatan</label>
                                                            <input class="form-control" name="NamaKegiatan" type="text" value="{{$data->NamaKegiatan}}" id="example-search-input">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="example-search-input" class="form-label">Nama Bidan</label>
                                                            <input class="form-control" name="NamaBidan" type="text" value="{{$data->NamaBidan}}" id="example-search-input">
                                                        </div>
                                                        <span style="float:right">

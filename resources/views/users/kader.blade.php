                ...
                @foreach ($anggota as $jabatan => $agt)
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="{{ str($jabatan)->slug() }}-tab"
                            data-bs-toggle="tab"
                            data-bs-target="#{{ str($jabatan)->slug() }}-tab-pane"
                            type="button"
                            role="tab"
                            aria-controls="{{ str($jabatan)->slug() }}-tab-pane"
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="tab-content" id="myTabContentAnggota">
                    @foreach ($anggota as $jabatan => $agt)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ str($jabatan)->slug() }}-tab-pane" role="tabpanel"
